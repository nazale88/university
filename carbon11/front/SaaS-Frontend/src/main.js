...
import NewsList from '@/views/dashboard/components/newsList.vue'  // 确保路径正确
import NoticeList from '@/views/dashboard/components/noticeList.vue'
import QuestionList from '@/views/dashboard/components/questionList.vue'
